    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                stmt.executeUpdate("update donor_registration set Password='" + Newpass + "' where Email='"+email+"'");
                //int i=stmt.executeUpdate("DELETE FROM `forgot_password_option1` WHERE CODE='"+code+"'");
                out.print("Successfully Change");
            } catch (Exception e) {
                System.out.print(e);
            }
        }
