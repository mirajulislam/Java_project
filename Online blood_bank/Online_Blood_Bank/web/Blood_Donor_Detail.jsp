            ...
            <div class="slider1">
                ...
                <div class="">
                    <div class="phpkida-main">
                        <h2>Donor Detail</h2>
                        <form id="Registration_Submit" action="#" method="post">
                            <input type="hidden" name="blood_id" value="<%=resultSet.getString("blood_id")%>">
                            <font size="3" color="white">Blood Id: <input type='text' name="blood_id" class="ggg"  name='id' value="<%=resultSet.getString("blood_id")%>" readonly></font> <br>  
                            <font size="3" color="white">Full Name:</font>  <input type="text" name="Full_Name"  class="ggg"  value="<%=resultSet.getString("Full_Name")%>" readonly><br>
                            <font size="3" color="white">Blood Group: </font> <input type="text" name="Blood_Group"  class="ggg" value="<%=resultSet.getString("Blood_Group")%>" readonly><br>
                            <font size="3" color="white">Last Blood Donation: </font> <input type="text" name="Last_Donation" class="ggg" value="<%=resultSet.getString("Last_Donation")%>" readonly><br>
                            <font size="3" color="white">Address: </font> <input type="text" name="Address" class="ggg" value="<%=resultSet.getString("Address")%>" readonly><br>
                            <font size="3" color="white">City:</font> <input type="text" name="City" class="ggg" value="<%=resultSet.getString("City")%>" readonly><br>                         
                            <div class="clearfix"></div>                          
                        </form>
                            <font size="5" color="blue">  <a href="Search_Blood.jsp">Back Profile</a>
                    </div>
                </div>
            </div>
        </div>
