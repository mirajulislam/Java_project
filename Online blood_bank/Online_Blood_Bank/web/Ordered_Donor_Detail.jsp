            ...
            <div class="slider1">
                ...
                <div class="">
                    <div class="phpkida-main">
                        <h2>Donor Detail of Give Blood</h2>
                        <form id="Ordered_Donor_submit" action="Donor_Detail_Ordered_Blood" method="post">                         
                            ...
                            <input id="Donated_Date" type="text" class="ggg" name="Donated_Date" placeholder="enter  Donation Date" required=""> <font size="3" color="white">(Donation-Date)---(yyyy-MM-dd)</font>
                            ...
                            <input id="Donor_register" type="submit" value="submit" name="register">
                        </form>
                    </div>
                </div>
            </div>
