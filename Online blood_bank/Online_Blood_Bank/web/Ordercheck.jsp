                    ...
                    <table>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="c7">Show Donor Profile</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
 ...
 <%
            ...
            %>      
                            <tr>
                                ...
                                <td class="c7"><a href="Donor_Profile_View.jsp?blood_id=<%=resultSet.getString("blood_id")%>"><button type="button" class="donor">search</button></a></td>
                            </tr>
                            <%
                                    }
                                    connection.close();
