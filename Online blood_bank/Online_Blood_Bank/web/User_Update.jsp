            ...
            <div class="slider1">
                ...
                <div>
                    <div class="phpkida-main">
                        ...
                        <form id="update_profile" action="UpdateServlet" method="post">

                            <font size="3" color="black">Id: ${user_id}<input id="user_id" type="hidden" class="ggg"  name='id' value='${user_id}' required=""></font> <br>  
                            <font size="3" color="white">User Name:</font> <input id="User_Name" type="text" class="ggg" name='User_Name' value='${User_Name}' required=""><br>
                             <font size="3" color="white">Full Name:</font>  <input id="Full_Name" type="text" class="ggg" name='Full_Name' value="${Full_Name}" required=""><br>
                             <font size="3" color="white">Location: </font> <input id="Address" type="text" class="ggg" name='Address' value="${Address}" required=""><br>
                             <font size="3" color="white">Last Blood Donation: </font> <input id="Last_Donation" type="text" class="ggg" name='Last_Donation' value="${Last_Donation}"required=""><br>
                             <font size="3" color="white">City: </font> <input id="City" type="text" class="ggg" name='City' value="${City}" required=""><br>
                             <font size="3" color="white">Mobile:</font> <input id="Mobile_Number" type="text" class="ggg" name='Mobile_Number' value="${Mobile_Number}"required=""><br>
                            <div class="clearfix"></div>
                            <input id="passwordSend" type="submit" value="Update" name="pass" >
                        </form>
