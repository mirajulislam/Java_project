                        ...
                        <div class="navbar-collapse collapse">							
                            <div class="menu">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation"><a href="Registration.jsp" class="active">Signup</a></li>
            ...
            <div class="slider1">
                ...
                <div class="">
                    <div class="phpkida-main">
                        <h2>Register Now</h2>
                        <form id="Registration_Submit" action="Registration_Store" method="post">
                            <input id="Full_Name" type="text" class="ggg" name="Full_Name" placeholder="enter FULL NAME" required="">
                            <input id="User_Name" type="text" class="ggg" name="User_Name" placeholder="enter USER NAME" required="">                         
                            <input id="Password" type="password" class="ggg" name="Password" placeholder="enter PASSWORD" required="">

                            <input id="Birthday_Day" type="text" class="ggg" name="Birthday_Day" placeholder="enter DATE OF BIRTH" required=""><font size="3" color="white">(Date-Of-Birth)--(yyyy-MM-dd)</font>
                            ...
                            <input id="Last_Donation" type="text" class="ggg" name="Last_Donation" placeholder="enter Last Donation" required=""><font size="3" color="white">(Last-Donation-Date)---(yyyy-MM-dd)</font>
                            <input id="Mobile_Number"  type="text" class="ggg" name="Mobile_Number" placeholder="enter MOBILE" required="">
                            <input id="Email" type="email" class="ggg" name="Email" placeholder="enter E-MAIL" required="">   

                            <select id="Gender" class="ggg" name="Gender">
                            ...
                            <input id="register" type="submit" value="submit" name="register">
                        </form>
