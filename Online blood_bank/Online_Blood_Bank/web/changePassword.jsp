            ...
            <div class="slider1">
                ...
                <div>
                    <div class="phpkida-main">
                        ...
                        <form id="new_password" action="Reset_Password" method="post">
                             <input type ='hidden' name='id' value='${user_id}'>
                            <input id="password1" type="password" class="ggg" name="current" placeholder="current password " required="">  
                            ...
                            <input id="passwordSend" type="submit" value="Change" name="pass" >
                        </form>
