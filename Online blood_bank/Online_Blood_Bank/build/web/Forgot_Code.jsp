            ...
            <div class="slider1">
                ...
                <div>
                    <div class="phpkida-main">
                        <h2>Enter code</h2>
                        <form id="codeSubmit" action="Code_Verification" method="post">
                            <input type ='hidden' name='email' value='${email}'>
                            <input id="code" type="text" class="ggg" name="code" placeholder="enter code " required="">                        
                            <div class="clearfix"></div>
                            <input id="" type="submit" value="Send" name="" >
                        </form>
