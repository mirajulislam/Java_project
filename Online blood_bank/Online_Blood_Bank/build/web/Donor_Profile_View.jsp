            ...
            <div class="slider1">
                ...
                <div class="">
                    <div class="phpkida-main">
                        <h2>Donor Detail</h2>
                        <form id="Store" action="#" method="">
                            <input type="hidden" name="blood_id" value="<%=resultSet.getString("blood_id")%>">
                            <font size="3" color="white">Blood Id: <input id="id" type='text' name="blood_id" class="ggg"  name='blood_id' value="<%=resultSet.getString("blood_id")%>" readonly></font> <br>                            
