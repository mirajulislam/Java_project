            ...
            <div class="slider1">
                ...
                <div class="">
                    <div class="phpkida-main">
                        ...
                        <form id="Order_Submit" action="Order" method="post">
                            <input type="hidden" name="blood_id" value="<%=resultSet.getString("blood_id")%>">
                            <font size="3" color="white">Blood Id: <input id="blood_id" type='text' name="blood_id" class="ggg"  name='id' value="<%=resultSet.getString("blood_id")%>" readonly></font> <br>                            
                            <font size="3" color="white">Blood Group: </font> <input id="Blood_Group" type="text" name="Blood_Group"  class="ggg" value="<%=resultSet.getString("Blood_Group")%>" readonly><br>
                            <font size="3" color="white">Price:</font> <input id="Price" type="text" name="Price" class="ggg" value="<%=resultSet.getString("Price")%>" readonly><br>
                            <font size="3" color="white">Delivery Date:</font> <input id="Delivary" type="text" name="Delivary" class="ggg"><br><font size="3" color="white"> (yyyy-mm-dd)<br><br>
                            <font size="3" color="white">Your Name: </font> <input id="Full_Name" type="text" name="Full_Name" class="ggg" ><br>
                            <font size="3" color="white">Your Mobile:</font> <input id="Mobile" type="text" name="Mobile" class="ggg" ><br>                         
                            <font size="3" color="white">Your Email: </font> <input id="Email" type="text" name="Email" class="ggg"><br>
                            <font size="3" color="white">Location: </font> <input id="Address" type="text" name="Address" class="ggg" ><br>
                            <font size="3" color="white">City:</font> <input id="City" type="text" name="City" class="ggg" ><br>                         
                            <div class="clearfix"></div>   
                             <input id="Order" type="submit" value="Order" name="order">
                        </form>
