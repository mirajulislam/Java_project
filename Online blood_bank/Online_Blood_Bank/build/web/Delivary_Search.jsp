            ...
            <div class="slider1">
                ...
                <div class="">
                    <div class="phpkida-main">
                        <h2>Search Blood</h2>
                        <form id="Delivary_submit" action="Delaviry_Submitet.jsp" method="post">                         
                            ...
                            <input id="Full_Name" type="text" class="ggg" name="Full_Name" placeholder="enter Customer Name" required="">

                            <input id="Delivary" type="text" class="ggg" name="Delivary" placeholder="enter Delivary  Date" required=""> <font size="3" color="white">(Donation-Date)---(yyyy-MM-dd)</font>

                            <div class="clearfix"></div>
                            <input id="Delivary_Check" type="submit" value="Search" name="Delivary_Check">
                        </form>                       
                    </div>
                </div>
            </div>
