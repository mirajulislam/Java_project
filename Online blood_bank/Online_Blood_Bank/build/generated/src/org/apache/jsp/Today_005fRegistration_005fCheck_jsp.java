...
public final class Today_005fRegistration_005fCheck_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    ResultSet resultSet = null;
      ...
      out.write("                                ");
                                    ...
                                    try {
                                        ...
                                        String sql = "select * from `donor_reg` where Last_Donation NOT BETWEEN '" + newDate + "' AND '" + present + "' AND (Blood_Group='" + Blood_Group + "' and  City='" + City + "')";
      ...
      out.write("</td>  \n");
      out.write("                                 <td class=\"c7\"><a href=\"#?id=");
      out.print(resultSet.getString("id"));
